...
\declaretheorem[numbered=no, style=thmgreenbox, name=Conjecture]{conjecture}
\declaretheorem[numberwithin=chapter, style=thmgreenbox, name=Theorem]{theorem}
\declaretheorem[sibling=theorem, style=thmredbox, name=Corollary]{corollary}
\declaretheorem[sibling=theorem, style=thmredbox, name=Consequence]{consequence}
